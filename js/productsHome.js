...
<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img class="p-8 h-64 mx-auto rounded-t-lg" src="https://m.media-amazon.com/images/I/613pEi4kmyL._AC_SL1500_.jpg"
                    alt="product image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
...
`
document.addEventListener("DOMContentLoaded", attachProductToHomePage)

function attachProductToHomePage(){
    ...
    displayProductSection.insertAdjacentHTML("beforeend", displayProductsWithHTML)
